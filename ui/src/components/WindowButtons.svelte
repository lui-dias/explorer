...
<div class="flex justify-end" id="window-buttons">
	<button type="button" class="px-4 py-2 hover:bg-zinc-700" on:click={py.minimize}>
		<Minimize class="fill-primary" />
	</button>
	<button type="button" class="px-4 py-2 hover:bg-zinc-700" on:click={py.maximize}>
		<Maximize class="fill-primary" />
	</button>
	<button type="button" class="px-4 py-2 hover:bg-red-500" on:click={py.close}>
